...
export default async function TikTokAccountsPage({
  ...
  if (!ws) {
    return <TikTokAccountsClient accounts={[]} activeType={activeType} />;
  }
  ...
  // Content stats + live median fallback
  ...
  // Quality score DESC, unscored last
  accounts.sort((a, b) => {
  ...
  return <TikTokAccountsClient accounts={accounts} activeType={activeType} />;
}
