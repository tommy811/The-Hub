...
export function CreatorsFilters({ counts, trackingCounts, activeStatus, activeTracking }: { counts: any, trackingCounts: any, activeStatus: string, activeTracking: string }) {
